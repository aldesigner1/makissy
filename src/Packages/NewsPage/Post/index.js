            ...
            <li>
                <div className="article">
                    ...
                    <div id="description">
                        ...
                        <div id="plus">
                            <Link to="#" data-tip="Message" data-toggle="tooltip" data-placement="bottom"> <i className="far fa-comment icon"></i></Link>
                            <Link to="#" data-tip="Maps" data-toggle="tooltip" data-placement="bottom"><i className="fas fa-map-marked-alt icon"></i></Link>
