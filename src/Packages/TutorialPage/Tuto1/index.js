...
function index() {
    return (
        <div className="contentTuto">
                <video id="video" src="Assets/audible/podcastepisode.mp3" controls />
                {/* <audio id="podcast" src="Assets/audible/podcastepisode.mp3" controls/> */}
                    ...
                    <p className="paragrapheTuto">En tant que personne faisant du commerce en Afrique, être une référence sur le marché ou simplement faire grandir son business, implique de le faire à la fois de manière traditionnelle, mais aussi en utilisant les ‘‘nouvelles technologies’’… <b id="gras" r /> Et malheureusement, c’est là que tout se gâte! Entre l’internet, le niveau de vie local et le marketing digital; eh bien, commençons par comprendre les bases de ce type de commerce qui se fait en ligne.</p>
                    <ol>
                        <li>
                        ...
                        <li>
                            ...
                            <p className="paragrapheTuto">Ce serait vous mentir de dire qu’il existe LA Méthode à suivre pour démarrer son business en ligne… La vérité est que, <b id="gras" >tout dépend de vous!</b>  Le mode de vie et l’entourage en passant par la détermination et les prédispositions à le faire, font que l’approche qui marcherait pour vous, puisse ne pas fonctionner pour une autre personne: C’est donc là toute la difficulté et la délicatesse du travail de <b id="gras" >conseiller marketing</b>. <b id="gras" r />  Néanmoins, ce qui vous aidera ce sont les acquis que vous faites au fur et à mesure que votre business prend forme et évolue, les livres que vous lisez, les vidéos, podcasts et autres types de cours en rapport avec le commerce digital; et le plus important encore:<b id="gras" > le passage à l’action </b>. Pour cela, voici quelques questions que vous pouvez vous poser si jamais vous décidez de démarrer votre commerce:</p>
                            <blockquote cite="http://">
                        ...
                        <li>
                            ...
                            <p className="paragrapheTuto">C’est assez tentant de s’inspirer des besoins du marché pour décider de se lancer dans les affaires en ligne, ou essayer de se concentrer sur ce qu’on sait et ce qu’on a pour démarrer. Et même en rapport avec ce sujet on entend dire – à tort ou à raison, on le verra par la suite – que ce sont la passion et la motivation qui comptent le plus au tout début de toute réalisation… OK, admettons...  Mais avant de répondre, gardez à l’esprit 02 choses:</p>
                            <blockquote cite="http://">
                            ...
                            <p className="paragrapheTuto">Les conseils d’experts un peu comme ceux cités plus haut, sont efficaces; mais dans ce contexte, il y a beaucoup d’éléments qui rentrent en compte et qui ne peuvent pas être négligés. Les idées, il y en a beaucoup… Un peu trop même. Et ce qui va faire la différence entre ce que vous faîtes et ce que votre voisin fera, ne va tenir qu’à un fil: <b id="gras" >“ Est-ce que je peux montrer ce que je voudrais faire ? ”</b>. <b id="gras" r /> Ici, nul besoin de longs discours, ce qui compte et donc ce qui rend une idée crédible, c’est si la personne à qui je parle peut <b id="gras" >voir, ressentir, vérifier (…) </b>que l’idée que j’ai, n’est pas juste abstraite. La démonstration peut concerner <b id="gras" >un accessoire, un plan, un prototype,</b> bref une partie du bien ou du service que vous voulez concevoir. Et donc il faudrait savoir si ce que vous faîtes, vous permet facilement de montrer aux autres <i>(vos prospects)</i> que votre bien ou service leur sera utile, que c’est du concret et que cela inspire une certaine originalité.</p>
                        ...
                        <li>
                            ...
                            <p className="paragrapheTuto">Ce n’est pas que les faux objectifs existent – peut-être bien, on ne sait jamais – mais le côté <b id="gras" >vrai</b> de l’objectif dont il est question ici, réside sur quelques points que les débrouillards du net et aussi ceux des marchés savent assez bien manier. <b id="gras" >Ce n’est pas parce qu’une idée est bonne, qu’elle est bonne pour vous!</b> Pour mieux le comprendre tentez donc de répondre, quelque part, à ces questions : </p>
                            <blockquote cite="http://">
                        ...
                        <li>
                            ...
                            <p className="paragrapheTuto">En somme, pour définir un business sur internet qui soit rentable, il vous faut vous poser les <b id="gras" >bonnes questions, </b>chercher une <b id="gras" >idée percutante </b> et trouver le point fort qui fait votre <b id="gras" >avantage </b> <i>(sans lequel il vous sera difficile d’atteindre votre propre objectif)</i> . Si vous partez de zéro, ce dernier viendra probablement de vous, de vos compétences, vos connaissances ou encore de votre personnalité. Mais attention, tout cela ne viendra pas juste en regardant des vidéos, en lisant ce tutoriel ou encore en attendant <b id="gras" >‘‘le bon moment’’</b> pour faire le premier pas, il apparaîtra en montant des projets et en remarquant là où, vous, êtes meilleur•e que les autres, là où vous pouvez facilement exprimer votre talent.</p>
