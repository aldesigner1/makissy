                ...
                <div className="contentTuto">
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <p className="paragrapheTuto">Ce serait vous mentir de dire qu’il existe LA Méthode à suivre pour démarrer son business en ligne… La vérité est que, <b>tout dépend de vous!</b>  Le mode de vie et l’entourage en passant par la détermination et les prédispositions à le faire, font que l’approche qui marcherait pour vous, puisse ne pas fonctionner pour une autre personne: C’est donc là toute la difficulté et la délicatesse du travail de <b>conseiller marketing</b>. <br />  Néanmoins, ce qui vous aidera ce sont les acquis que vous faites au fur et à mesure que votre business prend forme et évolue, les livres que vous lisez, les vidéos, podcasts et autres types de cours en rapport avec le commerce digital; et le plus important encore:<b> le passage à l’action </b>. Pour cela, voici quelques questions que vous pouvez vous poser si jamais vous décidez de démarrer votre commerce:</p>
                            <blockquote cite="http://">
                        ...
                        <li>
                            ...
                            <p className="paragrapheTuto">Ce n’est pas que les faux objectifs existent – peut-être bien, on ne sait jamais – mais le côté <b>vrai</b> de l’objectif dont il est question ici, réside sur quelques points que les débrouillards du net et aussi ceux des marchés savent assez bien manier. <b>Ce n’est pas parce qu’une idée est bonne, qu’elle est bonne pour vous!</b> Pour mieux le comprendre tentez donc de répondre, quelque part, à ces questions : </p>
                            <blockquote cite="http://">
