            ...
            posts: [
                {
                        nomUtil: "Annonce !!!",
                        categorie: "education",
                        titre: "Concours 2020 - Intelligentsia",
                        following: "Suivi...",
                        prix: "--",
                        devise: " XAF",
                        srcImage: "/Assets/images/test/icorp.gif",
                        profilePic: "Assets/icons/IMG_20200114_153834_752.jpg",
                        srcBlur: "assets/images/Icons Animation Inspiration.gif",
                        delai: "Aujourd'hui",
                        kiff: 17,
                        like: true,
                        ville: "Yaoundé || Lundi 27 Juillet - ",
                        desc: "Préparation aux concours de: Géologie Industrie Pétrole (EGE - FMIP); Ecoles Normales Supérieures d'Enseignement Technique (ENSET); Ecole Supérieure des Sciences et Techniques de l'Information et de la Communication (ESSTIC); Institut Universitaire des Technologies (IUT); Ecole Normale Supérieure (ENS); Ecole Nationale des Travaux Publics (ENSTP); Ecoles de Médecine (FMSB - FMSP - FHS - UDM - ISTM - CATUC - IDE); Ecole Nationale Supérieure des Postes et Télécoms (SUP'PTIC); Ecoles Nationales Supérieures Polytechniques (ENSPY - ENSPD - ENSPM - ENSPB)",
                        telephone: "+237 698 222 277",
                    },
                
                {
                    ...
                    prix: "",
                    devise: "",
                    srcImage: "assets/images/MiniatureMakissy.png",
                    profilePic: "Assets/icons/favicon.png",
                    srcBlur: "assets/images/Icons Animation Inspiration.gif",
                    delai: "Aujourd'hui",
                    kiff: 862,
                    like: true,
                ...
                //     nomUtil: "Fast_Sell",
                //     categorie: "",
                //     titre: "Levure - Sucre vanillé",
                //     following: "Suivre",
                //     prix: "--",
                //     devise: " XAF",
                //     srcImage: "/Assets/images/test/Screenshot_20200615-215300.png",
                ...
                //     like: true,
                //     ville: "Yaoundé ||",
                //     desc: "Sachets de levure et de sucre vanillé, disponibles en gros et détails... Faites l'appel",
                //     telephone: "+237 690 37 03 09"
                // },
                {
                    nomUtil: "Global_Clim",
                ...
                // },
                {
                    nomUtil: "Xenou",
                    categorie: "education",
                    titre: "Application mobile - Educative",
                    following: "Suivre",
                    prix: "--",
                    devise: " XAF",
                    srcImage: "/Assets/images/test/Screenshot_20200516-111228.png",
                    profilePic: "Assets/icons/e69d1c64-89f7-40f7-bde0-537b7b6fc8ee@2x.png",
                    srcBlur: "assets/images/Icons Animation Inspiration.gif",
                    delai: "hier",
                    kiff: 497,
                    like: true,
                    ville: "Yaoundé ||",
                    desc: "Premier réseau social éducatif au Cameroun. Spécialement conçu pour les élèves du secondaire en classe d'examen (troisième, première, terminale).",
                    telephone: "+237 658 086 738"
                },
                {
                    nomUtil: "Intelligentsia",
                    categorie: "Infographie",
                    titre: "Formation",
                    following: "Suivre",
                    prix: "--",
                    devise: " XAF",
                    srcImage: "/Assets/images/test/IMG-20200622-WA0052.jpg",
                    profilePic: "Assets/images/test/intelcorp.png",
                    srcBlur: "assets/images/Icons Animation Inspiration.gif",
                    delai: "hier",
                    kiff: 497,
                    like: true,
                    ville: "Yaoundé ||",
                    desc: "Des encadreurs hautement qualifiés, suivi particulier de chaque élève, ateliers d'orientation académique, service d'assistance à la confection des dossiers de concours, service d'aide à la recherche de logements, documentation de qualité (gratuite), préparation à l'orale et voyage d'étude à l'étranger. Un de tout ça vous intéresse ? Alors faites l'appel !",
                    telephone: "+237 698 222 277"
                },
                {
                    nomUtil: "Global_Accessories",
                    categorie: "Portable",
                    titre: "Pochettes mobiles",
                    following: "Suivi...",
                    prix: "--",
                    devise: " XAF",
                    srcImage: "/Assets/images/test/Screenshot_20200602-221254.png",
                    profilePic: "Assets/icons/e69d1c64-89f7-40f7-bde0-537b7b6fc8ee@2x.png",
                    srcBlur: "assets/images/Icons Animation Inspiration.gif",
                    delai: "hier",
                    kiff: 57,
                    like: true,
                    ville: "Yaoundé ||",
                    desc: "Venez voir notre catalogue et vous trouverez la pochette adaptée à votre mobile, chique et stylée; on attend vos impressions!",
                    telephone: "+237 6 99 39 78 50"
                },
                {
                ...
                {
                    nomUtil: "Web_Master_Freelance",
                    categorie: "education",
                    titre: "Formation Webmaster",
                    following: "Suivre",
                    prix: "100 000",
                    devise: " XAF",
                    srcImage: "/Assets/images/test/IMG-20200606-WA0067.jpg",
                    profilePic: "Assets/icons/e69d1c64-89f7-40f7-bde0-537b7b6fc8ee@2x.png",
                    srcBlur: "assets/images/Icons Animation Inspiration.gif",
                    delai: "hier",
                    kiff: 508,
                    like: true,
                    ville: "Yaoundé || ",
                    desc: "Gagnez votre vie en devenant webmaster. Apprenez en 01mois à créer et à administrer des sites web. Inscrivez-vous, en un coup de fil",
                    telephone: "+237 696 98 60 83"
                },
                ...
                // },
                {
                    nomUtil: "Metys_Vision",
                    categorie: "job",
                    titre: "Formation - Community Manager",
                    following: "Suivre",
                    prix: "55 000",
                    devise: " XAF",
                    srcImage: "/Assets/images/test/IMG-20200604-WA0051.jpg",
                    profilePic: "Assets/icons/e69d1c64-89f7-40f7-bde0-537b7b6fc8ee@2x.png",
                    srcBlur: "assets/images/Icons Animation Inspiration.gif",
                    delai: "il y a 02jours",
                    kiff: 17,
                    like: true,
                    ville: "Yaoundé ||",
                    desc: "Des stratégies secrètes pour réussir sur youtube, facebook et même instagram. Les cours se font en ligne. A vous de jouer.",
                    telephone: "+237 667 098 237 "
                },
                // {
                //     nomUtil: "BARDGOGE",
                ...
                // },
                {
                    ...
                    prix: "1 000",
                    devise: " XAF",
                    srcImage: "/Assets/images/test/IMG-20200404-WA0007.jpg",
                    profilePic: "Assets/icons/e69d1c64-89f7-40f7-bde0-537b7b6fc8ee@2x.png",
                    srcBlur: "assets/images/Icons Animation Inspiration.gif",
                    delai: "il y a 03jours",
                    kiff: 29,
                    like: true,
                    ville: "Yaoundé ||",
                    desc: "Nous faisons les courses à votre place ! Venez passer vos commandes...",
                    telephone: "+237 699 56 76 95"
                },
                {
                    nomUtil: "Pacy Delice",
                    categorie: "ALIMENT",
                ...
                // },
                {
                    ...
                    prix: "1 500",
                    devise: " XAF",
                    srcImage: "/Assets/images/test/IMG-20200127-WA0009.jpg",
                    profilePic: "Assets/icons/e69d1c64-89f7-40f7-bde0-537b7b6fc8ee@2x.png",
                    srcBlur: "assets/images/Icons Animation Inspiration.gif",
